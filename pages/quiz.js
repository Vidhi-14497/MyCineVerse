    ...
    //     qText.textContent = `Q${currentIndex + 1}. ${item.q}`;
    ...
    //       feedback.textContent = `❌ Wrong — correct answer: ${String.fromCharCode(
    //         65 + correct
    //       )}. ${questions[currentIndex].options[correct]}`;
    //     }
    //     scoreText.textContent = `Score: ${score}/${questions.length}`;
    //     // show Next or Finish
